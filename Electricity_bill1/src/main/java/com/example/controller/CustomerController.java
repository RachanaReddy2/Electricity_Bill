...
public class CustomerController {
	...
	public ResponseEntity<Customer> viewCustomerProfile(@PathVariable String customerId)  {
	...
	public ResponseEntity<Customer> searchCustomerByAadhaar(@Valid @PathVariable String aadhaar) {
		Customer customer = customerService.searchCustomerByAadhaar(aadhaar);
		return new ResponseEntity<Customer>(customer, HttpStatus.OK);
	}

	@GetMapping(value = "/mobile/{mobileNumber}")
	public ResponseEntity<Customer> searchCustomerByMobile( String mobileNumber) {
